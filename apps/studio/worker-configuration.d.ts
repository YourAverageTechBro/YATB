/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 658629acfa6ccdee5531ecc7feb8d504)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MEDIA: R2Bucket;
	DB: D1Database;
	AUTH_EMAIL: SendEmail;
	VIDEO_COMPRESSION_QUEUE: Queue;
	...
	VIDEO_TRANSCODER: DurableObjectNamespace<import("./src/server").CompressionContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CompressionContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "EMAIL_MODE" | "EMAIL_FROM" | "BETTER_AUTH_SECRET">> {}
}
