...
import { formatUploadedDate, parseShareToken } from '#/domain/file-library'
...
function SharedFilePage() {
  ...
  return <main className="shared-file-page">
    ...
    <Card className="shared-file-card">
      ...
      <p className="shared-file-context">From {videoTitle} · Uploaded {formatUploadedDate(file.createdAt)}</p>
